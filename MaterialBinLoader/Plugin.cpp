...
void* findAddr(std::string name) {	
	...
	case do_hash("AppPlatform::readAssetFile"): {
		...
		FIND_ADDR("1.20.71.01", "8 89 5C 24 ? 55 56 57 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 49 8B C0 48 8B FA 48 89 95 ? ? ? ?");
		FIND_ADDR("1.20.80.20", "48 89 5C 24 ? 48 89 74 24 ? 55 57 41 54 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 ? 49 8B C0 48 8B FA");
		FIND_ADDR("1.20.80.21", "48 89 5C 24 ? 48 89 74 24 ? 55 57 41 54 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 49 8B C0");
		FIND_ADDR("1.20.80.05", "48 89 5C 24 ? 55 56 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 49 8B C0 48 8B FA");
		FIND_ADDR("1.21.20.24", "48 89 5C 24 ? 55 56 57 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 49 8B F8 48 8B F2 48 89 55 ? ? ? ?");
	...
	case do_hash("ResourcePackManager::ResourcePackManager"): {
		...
		//1.20.30.21 preview L#283
		FIND_ADDR("1.20.30.21", "4C 8B DC 53 55 56 57 41 56 48 81 EC ? ? ? ? 41 0F B6 E9 49 8B D8 48 8B F2 48 8B F9");
		FIND_ADDR("1.21.20.24", "4C 8B DC 53 55 56 57 41 56 48 81 EC ? ? ? ? 41 0F B6 E9 49 8B F0 48 8B FA 48 8B D9");
		////////////////////////error/////////////////////
		CreateConsole();
